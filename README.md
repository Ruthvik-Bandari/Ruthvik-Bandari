...
currently:
  ...
  - Maintaining a daily GitHub commit streak
...
### 🦶 DiaFoot.AI
**Diabetic Foot Ulcer Detection & Segmentation**

`DINOv2` `ViT-B/14` `UPerNet` `LoRA` `MONAI` `ONNX` `FastAPI`

- 🎯 98.36% accuracy, 99.91% AUROC (classifier)
- 🧠 89.12% Dice, 82.87% IoU (segmenter)
- ⚡ 4.5x CPU speedup via ONNX (235ms)
- 📊 8,105 curated medical images
- 🏥 Clinician deferral system at 99.72% accuracy
...
- 🤖 Multi-model RL defense optimization
- 📄 Published in IEEE TechRxiv
- 🔍 4-level NLP severity classification
...
### 🧠 NeuroNav
**BCI Neural Signal Processing System**

`FastAPI` `MNE-Python` `React Three Fiber` `WebSocket` `scikit-learn`

- ⚡ Real-time 32x32 ECoG grid processing
- 📡 5-band spectral feature extraction
- 🎯 Kalman filter hotspot scoring
- 🎵 Tone.js audio feedback
- 🖥️ 3D brain visualization frontend
...
`Python` `Flask` `Plotly` `BeautifulSoup` `NumPy` `Pandas`

- 🔍 File signature analysis (magic numbers)
- 🦠 Malware signature scanning
- 🔐 Hash calculation (MD5 to SHA512)
...
|---------|------|------------|
| **ScholarMine** | OpenReview, OpenAlex, HDBSCAN, MetaGPT | 5,000+ papers, 12 topic clusters, 16-person team |
| **MindCare AI** | NLP, RAG, API Integration | 40% better context retention vs MetaGPT baseline |
| **Customer Intelligence** | K-Means, Linear Regression, Tableau | 50,000+ records, 89% classification accuracy |
| **IPEDS Pipeline** | Polars, PyArrow, Pandera, GitHub Actions | 3M+ rows, 28 CSVs, 47 schema changes |
| **College Scorecard** | Random Forest, SHAP, Tableau | R² = 0.934 across 5,280 institutions |
| **Speech to Text API** | Whisper (5 variants), FastAPI, AES-GCM | Batch + streaming inference, WER evaluation |
| **Course Review Sentiment** | DistilBERT, DuckDB, Tableau | 83.8% accuracy, 5,000 reviews, 12 departments |
| **Higher Ed Text Analytics** | BERTopic, HDBSCAN, KeyBERT | 238 ERIC abstracts, topic + sentiment analysis |
...
<tr>
<td>📘</td>
<td><b>Automating Research Intelligence: AI-Generated vs Manually Designed Pipelines</b><br/>IEEE TechRxiv — DOI: <a href="https://doi.org/10.36227/techrxiv.177040642.26830215/v1">10.36227/techrxiv.177040642.26830215/v1</a>, 2025</td>
</tr>
<tr>
<td>📗</td>
...
🥈 **Runner-Up** — BASE 44 Hackathon (HushMap: real-time study space finder)

🏅 **Finalist** — Subconscious AI × ACM Hackathon (Blood report analyser)

🔓 **Open Source** — 2,300+ line PR to Instructor Python Library (PR #1968)

👨‍💼 **ACM Lead** — 10+ workshops, 100+ students trained, 3 years (2022-2025)
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0D47A1,50:1565C0,100:00E5FF&height=120&section=footer&fontSize=20&fontColor=FFFFFF"/>
